...
{
	/// <summary>
	/// 数据访问类:VIEW_Base_Site_DutyPlace
	/// </summary>
	public partial class VIEW_Base_Site_DutyPlace
	{
		...
		public TF.RunSafty.Model.VIEW_Base_Site_DutyPlace GetModel(int nId)
		{
			...
			strSql.Append("select  top 1 nId,strTrainJiaoluGUID,strPlaceID,strSiteGUID,nPlaceIndex,strPlaceName,strWorkShopGUID,dtCreateTime from VIEW_Base_Site_DutyPlace ");
			...
			TF.RunSafty.Model.VIEW_Base_Site_DutyPlace model=new TF.RunSafty.Model.VIEW_Base_Site_DutyPlace();
		...
		/// 得到一个对象实体
		/// </summary>
		public TF.RunSafty.Model.VIEW_Base_Site_DutyPlace DataRowToModel(DataRow row)
		{
			TF.RunSafty.Model.VIEW_Base_Site_DutyPlace model=new TF.RunSafty.Model.VIEW_Base_Site_DutyPlace();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select nId,strTrainJiaoluGUID,strPlaceID,strSiteGUID,nPlaceIndex,strPlaceName,strWorkShopGUID,dtCreateTime ");
			strSql.Append(" FROM VIEW_Base_Site_DutyPlace ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" nId,strTrainJiaoluGUID,strPlaceID,strSiteGUID,nPlaceIndex,strPlaceName,strWorkShopGUID,dtCreateTime ");
			strSql.Append(" FROM VIEW_Base_Site_DutyPlace ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_Base_Site_DutyPlace ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_Base_Site_DutyPlace T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_Base_Site_DutyPlace";
        ...
        /// 获取指定区段所有的出勤点
        /// </summary>
        /// <param name="strTrainJiao"></param>
        /// <returns></returns>
        public DataSet GetPlaceOfTrainJiaolu(string strTrainJiao)
        {
            string strWhere = string.Format(" strTrainJiaoluGUID='{0}' ", strTrainJiao);
            return GetList(strWhere);
        }
