/**  版本信息模板在安装目录下，可自行修改。
* TAB_Base_TrainJiaolu_DutyPlace.cs
*
* 功 能： N/A
* 类 名： TAB_Base_TrainJiaolu_DutyPlace
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
...
{
	/// <summary>
	/// 数据访问类:TAB_Base_TrainJiaolu_DutyPlace
	/// </summary>
	public partial class TAB_Base_TrainJiaolu_DutyPlace
	{
		public TAB_Base_TrainJiaolu_DutyPlace()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
        {
            ...
            strSql.Append("select max(nID) FROM TAB_Base_TrainJiaolu_DutyPlace ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from TAB_Base_TrainJiaolu_DutyPlace");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TAB_Base_TrainJiaolu_DutyPlace(");
			strSql.Append("strTrainJiaoluGUID,strPlaceID,nPlaceIndex)");
			...
			parameters[2].Value = model.nPlaceIndex;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TAB_Base_TrainJiaolu_DutyPlace set ");
        ...
        public bool DeleteByTrainJiaoluGUID(string strTrainJiaoLuGUID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TAB_Base_TrainJiaolu_DutyPlace ");
            strSql.Append(" where strTrainJiaoluGUID=@strTrainJiaoluGUID");
            SqlParameter[] parameters = {
					new SqlParameter("@strTrainJiaoluGUID", SqlDbType.VarChar)
			};
            parameters[0].Value = strTrainJiaoLuGUID;
		...
		/// 得到一个对象实体
		/// </summary>
		public TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace GetModel(int nId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 nId,strTrainJiaoluGUID,strPlaceID,nPlaceIndex from TAB_Base_TrainJiaolu_DutyPlace ");
			strSql.Append(" where nId=@nId");
			SqlParameter[] parameters = {
					new SqlParameter("@nId", SqlDbType.Int,4)
			};
			...
			TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace model=new TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace();
		...
		/// 得到一个对象实体
		/// </summary>
		public TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace DataRowToModel(DataRow row)
		{
			TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace model=new TF.RunSafty.Model.TAB_Base_TrainJiaolu_DutyPlace();
			if (row != null)
			{
        ...
        /// 获取指定区段所有的出勤点
        /// </summary>
        /// <param name="strTrainJiaolu">交路GUID</param>
        /// <returns></returns>
        public DataSet GetPlaceOfTrainJiaolu(string strTrainJiaolu)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * ");
            strSql.AppendFormat(" FROM TAB_Base_DutyPlace where strTrainJiaoluGUID='{0}'",strTrainJiaolu);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select nId,strTrainJiaoluGUID,strPlaceID,nPlaceIndex ");
			strSql.Append(" FROM TAB_Base_TrainJiaolu_DutyPlace ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" nId,strTrainJiaoluGUID,strPlaceID,nPlaceIndex ");
			strSql.Append(" FROM TAB_Base_TrainJiaolu_DutyPlace ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TAB_Base_TrainJiaolu_DutyPlace T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TAB_Base_TrainJiaolu_DutyPlace";
