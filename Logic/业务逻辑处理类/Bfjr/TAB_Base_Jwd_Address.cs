...
{
	/// <summary>
	/// TAB_Base_Jwd_Address
	/// </summary>
	public partial class TAB_Base_Jwd_Address
	{
		private readonly TF.RunSafty.DAL.TAB_Base_Jwd_Address dal=new TF.RunSafty.DAL.TAB_Base_Jwd_Address();
		...
		/// 获得数据列表
		/// </summary>
		public List<TF.RunSafty.Model.TAB_Base_Jwd_Address> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TF.RunSafty.Model.TAB_Base_Jwd_Address> DataTableToList(DataTable dt)
		{
			List<TF.RunSafty.Model.TAB_Base_Jwd_Address> modelList = new List<TF.RunSafty.Model.TAB_Base_Jwd_Address>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TF.RunSafty.Model.TAB_Base_Jwd_Address model;
