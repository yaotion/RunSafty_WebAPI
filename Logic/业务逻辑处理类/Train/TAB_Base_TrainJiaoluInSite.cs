...
namespace TF.RunSafty.BLL
{
	...
	{
		private readonly TF.RunSafty.DAL.TAB_Base_TrainJiaoluInSite dal=new TF.RunSafty.DAL.TAB_Base_TrainJiaoluInSite();
		...
		{
			return dal.Exists(strSiteGUID,strTrainJiaoluGUID);
		}
		...
		public bool Delete(string strSiteGUID,string strTrainJiaoluGUID)
		{
			...
			return dal.Delete(strSiteGUID,strTrainJiaoluGUID);
		}
		...
		public TF.RunSafty.Model.TAB_Base_TrainJiaoluInSite GetModel(string strSiteGUID,string strTrainJiaoluGUID)
		{
			...
			return dal.GetModel(strSiteGUID,strTrainJiaoluGUID);
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<TF.RunSafty.Model.TAB_Base_TrainJiaoluInSite> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TF.RunSafty.Model.TAB_Base_TrainJiaoluInSite> DataTableToList(DataTable dt)
		{
			List<TF.RunSafty.Model.TAB_Base_TrainJiaoluInSite> modelList = new List<TF.RunSafty.Model.TAB_Base_TrainJiaoluInSite>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TF.RunSafty.Model.TAB_Base_TrainJiaoluInSite model;
