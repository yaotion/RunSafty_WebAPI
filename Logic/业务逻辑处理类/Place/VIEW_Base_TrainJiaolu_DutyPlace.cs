...
{
	/// <summary>
	/// VIEW_Base_TrainJiaolu_DutyPlace
	/// </summary>
	public partial class VIEW_Base_TrainJiaolu_DutyPlace
	{
		private readonly TF.RunSafty.DAL.VIEW_Base_TrainJiaolu_DutyPlace dal=new TF.RunSafty.DAL.VIEW_Base_TrainJiaolu_DutyPlace();
		...
		/// 获得数据列表
		/// </summary>
		public List<TF.RunSafty.Model.VIEW_Base_TrainJiaolu_DutyPlace> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TF.RunSafty.Model.VIEW_Base_TrainJiaolu_DutyPlace> DataTableToList(DataTable dt)
		{
			List<TF.RunSafty.Model.VIEW_Base_TrainJiaolu_DutyPlace> modelList = new List<TF.RunSafty.Model.VIEW_Base_TrainJiaolu_DutyPlace>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TF.RunSafty.Model.VIEW_Base_TrainJiaolu_DutyPlace model;
        ...
        /// <returns></returns>
        public List<TF.RunSafty.Model.VIEW_Base_TrainJiaolu_DutyPlace> GetPlaceOfTrainJiaolu(string strTrainJiaolu)
        {
        ...
        public string GetPlacesOfJiaolu(string data)
        {
            JsonModel jsonModel = new JsonModel();
            try
            {
                ParamModel paramModel = Newtonsoft.Json.JsonConvert.DeserializeObject<ParamModel>(data); 
                List<TF.RunSafty.Model.VIEW_Base_TrainJiaolu_DutyPlace> placeList = this.GetPlaceOfTrainJiaolu(paramModel.data.trainjiaoluID);
                jsonModel.result = 0;
