...
{
	/// <summary>
	/// TAB_ReadDoc:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class TAB_ReadDoc
	{
		...
		private DateTime? _dtuptime;
		private int? _nreadmode;
		private int? _nreadinterval;
		/// <summary>
		/// 
		/// </summary>
		public int nid
		...
		{
			set{ _nreadmode=value;}
			get{return _nreadmode;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			set{ _nreadinterval=value;}
			get{return _nreadinterval;}
		}
		#endregion Model
