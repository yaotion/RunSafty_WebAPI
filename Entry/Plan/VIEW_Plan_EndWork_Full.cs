...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2014/9/28 13:57:23   N/A    初版
*
...
{
	/// <summary>
	/// VIEW_Plan_EndWork_Full:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class VIEW_Plan_EndWork_Full
	{
		...
		private DateTime? _dtturnstarttime;
		private int? _bsigned;
		private int? _bisover;
		private int? _nturnminutes;
		private int? _nturnalarmminutes;
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public DateTime? dtTurnStartTime
		{
			set{ _dtturnstarttime=value;}
			get{return _dtturnstarttime;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			set{ _nturnminutes=value;}
			get{return _nturnminutes;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			set{ _nturnalarmminutes=value;}
			get{return _nturnalarmminutes;}
		}
		#endregion Model
