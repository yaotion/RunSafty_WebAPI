<%@ WebHandler Language="C#"  Class="TF.RunSaftyAPI.App_Api.Public.Trainman.CommitFingerPic" %>
using System;
...
namespace TF.RunSaftyAPI.App_Api.Public.Trainman
{
    ...
    public class CommitFingerPic : IHttpHandler
    {
        ...
        private string gotoCommitFingerPic()
        {
            ...
            string strSql = "UPDATE TAB_Org_Trainman SET FingerPrint1 =@Finger1, FingerPrint2 =@Finger2, Picture =@Pic WHERE (strTrainmanGUID = '@userID')";
            ...
            strSql = "UPDATE TAB_System_Config SET strValue ='"+strGuid+"'  WHERE (strSection = 'SysConfig') AND (strIdent = 'ServerFingerLibGUID')";
