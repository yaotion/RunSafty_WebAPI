<%@ WebHandler Language="C#" Class="TF.RunSaftyAPI.App_Api.Public.Trainman.TrainmanList" %>
using System;
...
namespace TF.RunSaftyAPI.App_Api.Public.Trainman
{
    ...
    public class TrainmanList : IHttpHandler
    {
        ...
        private string gotoTrainman()
        {
    	    ...
    	    if (dt.Rows.Count < 1)
                return "{\"result\":0,\"resultStr\":\"暂无数据\",\"totalCount\":100,\"index\":1,\"nid\":12345,\"trainmanList\":[{\"trainmanid\":\"\",\"trainmanNumber\":\"\",\"trainmanName\":\"\",\"finger1\":\"\",\"finger2\":\"\",\"pic\":\"\"}]}";
		...
		string nid = dt.Rows[x]["nID"].ToString();
